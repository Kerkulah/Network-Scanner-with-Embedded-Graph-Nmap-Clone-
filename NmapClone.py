...
window = tk.Tk()                                                   # Create ythe GUI window
window.title("Network Scanner with Embedded Graph")
window.geometry("1000x1000")

tk.Label(window, text="Source IP:").pack()
src_entry = tk.Entry(window)
src_entry.pack()

tk.Label(window, text="Destination IP:").pack()
dst_entry = tk.Entry(window)
dst_entry.pack()

tk.Label(window, text="Port Range (e.g., 20-80):").pack()
...
results_widget = tk.Text(window, height=10, width=70)
results_widget.pack()
...
graph_frame = tk.Frame(window)                                        #set the embedded Graph Frame
